...
fn create_config_files(target_dir string) !string {

	md_file_path := os.join_path(target_dir,  "README.md")

	if !os.exists(md_file_path) {
		md_file_content := ('
...
')
	...
	if !os.exists(v_file_path) {
		file_content := ('
# Once modified with real values, make sure This file is in your .gitignore
